...
# run HypPiper
#obj2 = HPtools.RunHybPiper(ref=alignFile,naU='data/namelistUnique.subset.txt',naS='data/namelistScratch.subset.txt',tvals=[56,60,64,68,72,76,80,84], assembDir=outDirAssembs,HPshFile='sodiumChannelPaperAnalyses/scripts/run_tests.sh')
