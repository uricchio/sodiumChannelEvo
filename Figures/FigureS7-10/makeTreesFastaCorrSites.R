...
fasta<-read.fasta("~/projects/poison/sodiumChannelPaper/Figures/Figure3/plot_data/SCN4A.PROT.trimmed.manual.fa",seqtype="AA",as.string=TRUE)
...
myMSAL<-ggmsa("~/projects/poison/sodiumChannelPaper/Figures/Figure3/plot_data/SCN4A.PROT.trimmed.manual.fa.ordered.corr",1 ,6, font = "DroidSansMono", char_width = 0.5, seq_name = FALSE,color="LETTER")+geom_seqlogo(adaptive = FALSE,color="LETTER")+theme(legend.position="none") +theme(plot.margin = margin(0,0,0,0, "cm"))+theme(axis.title.x=element_blank(),
...
ggsave("~/projects/poison/sodiumChannelPaper/Figures/Figure3/SCN4A.PROT.corr.png",width=5,height=3*6.7)
